    ...
    >
      ...
      <div className="p-4 border-b border-white/10">
        <Link href="/" className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-[#7C3AED] to-[#A855F7] rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    >
                      ...
                      {!collapsed && (
                        <>
                          ...
                          {item.badge && (
                            <span className="px-2 py-0.5 text-[10px] font-semibold bg-purple-500/30 text-purple-300 rounded-full">
                              {item.badge}
                            </span>
                          )}
                        </>
