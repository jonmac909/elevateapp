  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="p-4 border border-[#E4E4E4] rounded-xl hover:border-[#47A8DF] transition-colors flex flex-col">
          <div className="text-2xl mb-2">📄</div>
          <h4 className="font-semibold text-[#11142D] mb-1">Landing Page Generator</h4>
          <p className="text-sm text-[#808191] mb-3 flex-1">Generate a complete landing page with 13 blocks</p>
          <button
        ...
        <div className="p-4 border border-[#E4E4E4] rounded-xl hover:border-[#47A8DF] transition-colors flex flex-col">
          ...
          <p className="text-sm text-[#808191] mb-3 flex-1">Generate daily content for your launch</p>
          <button
        ...
        <div className="p-4 border border-[#E4E4E4] rounded-xl hover:border-[#47A8DF] transition-colors flex flex-col">
          ...
          <p className="text-sm text-[#808191] mb-3 flex-1">Create your pricing and bonus stack</p>
          <button
