...
export const metadata: Metadata = {
  title: "Elevate Academy - Build Apps with AI",
        ...
        <div className="min-h-screen">
          ...
          <header className="bg-white border-b border-[#E4E4E4] sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-8 h-16 flex items-center justify-between">
              <a href="/elevate" className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-bold text-[18px] text-[#11142D]">Elevate Academy</span>
                  <p className="text-[11px] text-[#808191]">App Builder Platform</p>
                </div>
              </a>
              
              <nav className="flex items-center gap-6">
                <a href="/elevate" className="text-sm font-medium text-[#808191] hover:text-[#11142D]">Dashboard</a>
                <a href="/elevate/templates" className="text-sm font-medium text-[#808191] hover:text-[#11142D]">Templates</a>
              </nav>
            </div>
          </header>
